...
namespace scene
{
	...
	//! Initializes the terrain data. Loads the vertices from the heightMapFile
	bool TerrainSceneNode::loadHeightMapRAW(io::IReadFile* file,
	...
	//! Returns the mesh
	IMesh* TerrainSceneNode::getMesh() { return Mesh; }
	...
	void TerrainSceneNode::getMeshBufferForLOD(IDynamicMeshBuffer& mb, s32 LOD ) const
	{
		if (!Mesh->getMeshBufferCount())
			return;
	...
	void TerrainSceneNode::scaleTexture(f32 resolution, f32 resolution2)
	{
	...
	u32 TerrainSceneNode::getIndex(const s32 PatchX, const s32 PatchZ,
	...
	//! smooth the terrain
	void TerrainSceneNode::smoothTerrain(IDynamicMeshBuffer* mb, s32 smoothFactor)
	{
	...
	void TerrainSceneNode::calculateNormals(IDynamicMeshBuffer* mb)
	{
		s32 count;
	...
	void TerrainSceneNode::serializeAttributes(io::IAttributes* out,
	...
	void TerrainSceneNode::deserializeAttributes(io::IAttributes* in,
